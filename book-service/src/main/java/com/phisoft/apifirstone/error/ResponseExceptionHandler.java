...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * This one sends a custom com.phisoft.apifirstone.error message when book-not-found exception is thrown
    ...
    /**
     * This one sends a custom com.phisoft.apifirstone.error message when not-authorized-exception exception is thrown
     * @param exception book not found exception
     * @param webRequest the web request
     * @return response entity with the custom message
     */
